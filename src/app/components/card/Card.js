...
function Card({data}) {
  ...
  return (
    <Link href={{
        ...
        <div className="container max-w-sm border-2 border-blue-500 rounded-lg shadow-lg overflow-hidden">
            <img src={data.imagePath} alt={data.name} className="w-full h-48 object-cover"/>
            <div className="p-4">
