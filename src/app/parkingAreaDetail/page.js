        ...
        <Layout>
            <div className="bg-gray-100 min-h-screen flex flex-col lg:flex-row justify-around items-center">
                ...
                <div className="bg-white shadow-md rounded-lg overflow-hidden w-full lg:w-2/3 max-w-2xl mb-8 lg:mb-0">
                    <img src={data.imagePath} alt={data.name} className="w-full h-64 object-cover rounded-t-lg" />
                    <div className="p-6">
                ...
                {/* Form Component */}
                <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg p-6 w-full lg:w-1/3 max-w-lg flex flex-col gap-y-8">
                    <h2 className="text-2xl text-center uppercase font-semibold mb-4">Reserve Parking</h2>
                    <div className="mb-4">
                        <label htmlFor="parkingType" className="block text-gray-700 font-semibold mb-2">Parking Type</label>
                        <select
                            id="parkingType"
                            name="parkingType"
